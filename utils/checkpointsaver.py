...
#this is for saving best checkpoints in tensorflow 1.x
class BestCheckpointSaver(object):
    ...
    def handle(self, value, sess, global_step_tensor,name):
    ...
    def _remove_outdated_checkpoint_files(self, worst_checkpoint):
        os.remove(os.path.join(self._save_dir, 'best_checkpoints'))
